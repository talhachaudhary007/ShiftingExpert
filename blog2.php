...
?>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3">Featured Blog</h1>
            <div class="d-inline-flex align-items-center text-white">
                <p class="m-0"><a class="text-white" href="">Home</a></p>
                <i class="fa fa-circle px-3"></i>
                <p class="m-0"> Highlights</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
        ...
        <div class="px-2">
            <h6 class="text-primary text-uppercase font-weight-bold">Discover Our</h6>
            ...
            <div class="col-md-4 mb-3">
              ...
              <div class="col-md-4 mb-3">
                <div class="card blog-card">
                  ...
                  <div class="blog-card-overlay"></div>
                  <div class="card-body d-flex flex-column">
                    <h5 class="card-title">Sharjah Reliable Movers</h5>
                    <p class="card-text flex-grow-1">Are you looking for a MOVERS AND PACKERS SERVICE COMPANY In SHARJAH? So, here is the complete information about your search.</p>
                    <a href="sharjah.php" class="btn btn-primary blog-read-more-btn">Read More</a>
                  </div>
                </div>
            ...
            <div class="col-12">
                <nav aria-label="Page navigation">
                  <ul class="pagination pagination-lg justify-content-center mb-0">
                    <li class="page-item">
                      <a class="page-link" href="blog1.php" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                        <span class="sr-only">Previous</span>
                      </a>
                    </li>
                    <li class="page-item"><a class="page-link" href="blog1.php">1</a></li>
                    <li class="page-item active"><a class="page-link" href="blog2.php">2</a></li>
                    <li class="page-item"><a class="page-link" href="blog3.php">3</a></li>
                    <li class="page-item">
                      <a class="page-link" href="blog3.php" aria-label="Next">
